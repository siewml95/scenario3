...
public class DraggableNode extends AnchorPane {
			...
			parentProperty().addListener(new ChangeListener() {
                ...
                public void changeImage() {
                    if(checkbox.isSelected()) {
                       getStyleClass().add("svitch-on");
                       getStyleClass().remove("svitch-off");
                       System.out.println("svitch-on");
                               
                    }
                    else {
                        getStyleClass().remove("svitch-on");
                        getStyleClass().add("svitch-off");
                    }
                    
                }
                
             /*   public boolean checkSameNode(){
                    String first = mLinkIds.get(0);
                    String second = mLinkIds.get(1);
                    return first.equals(second);
                } */
                
                public String getConnectedLink() {                    
                    return mLinkIds.get(0);
                }
              ...
              /*  public ArrayList<String> getSeriesNodes() {
                    String first = mLinkIds.get(0);
		...
		public void setType (DragIconType type) {
			...
			getStyleClass().clear();
			getStyleClass().add("draggable");
			
			switch (mType) {
			
			case svitch:
				getStyleClass().add("icon-svitch");
			break;
			...
			case volt:
				getStyleClass().add("icon-volt");
			break;

			case am:
				getStyleClass().add("icon-am");
			break;
			...
			break;
                ...
                public String getValue() {
                    if(mType.equals(DragIconType.svitch)) {
                        if(!(checkbox.isSelected()))
                            return "0";
                        else
                            return "1";
